...
MODEL_PATH_O = "output/v4_epm_model_O.pkl"
MODEL_PATH_D = "output/v4_epm_model_D.pkl"
MODEL_META_PATH = "output/v4_epm_features.json"
...
if not APPLY_ONLY:
    ...
    with open("output/v4_epm_model.json", "w") as f:
