...
RAPM_POOLED    = "output/rapm_results.csv"
RAPM_SEASON    = "output/rapm_by_season.csv"
BOOT_SE        = "output/rapm_bootstrap_se.csv"
BOX_SCORE      = "output/box_score_ratings.csv"
PP_RAPM        = "output/pp_rapm.csv"
SKATERS_GAME   = "data/skaters_by_game.csv"
OUT_POOLED     = "output/final_ratings.csv"
OUT_SEASON     = "output/final_ratings_by_season.csv"
