...
PENALTY_FILE = Path("data/v2_penalties.csv")
OUT_PRIOR    = Path("data/v2_box_prior.csv")
OUT_CALIB    = Path("data/v2_prior_calibration.json")

# Use v2 raw RAPM if available, otherwise fall back to v1
RAPM_FILE = Path("data/v2_rapm_raw.csv")
