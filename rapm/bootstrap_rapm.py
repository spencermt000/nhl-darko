...
Output:
  output/rapm_bootstrap_se.csv — player_id, BPR_O_se_boot, BPR_D_se_boot, BPR_se_boot
"""
...
out.to_csv("output/rapm_bootstrap_se.csv", index=False)
print(f"\nWrote {len(out):,} players to output/rapm_bootstrap_se.csv", file=sys.stderr)
