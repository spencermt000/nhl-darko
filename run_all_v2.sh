...
log "Step 2/7: rapm_v2.py --mode=raw (uninformed RAPM, training target for box_prior)..."
...
log "  data/v2_gar_pooled.csv + v2_gar_by_season.csv + v2_goalie_war.csv"
